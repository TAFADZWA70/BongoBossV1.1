...
function displayUserInfo(userData) {
    ...
    if (userRoleElement) {
        userRoleElement.textContent = userData.accountType === 'customer' ? 'Customer' : 'Provider';
    }
    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const ticketData = {
                ...
                userType: currentUserData?.accountType || 'Unknown',
            ...
            formData.append("subject", `BongoBoss Support: ${subject}`);
...
Name: ${name}
Email: ${email}
User ID: ${currentIdNumber || 'Unknown'}
Account Type: ${currentUserData?.accountType || 'Unknown'}
...
Submitted: ${new Date().toLocaleString()}
            ...
            alert(`Failed to send message: ${error.message}. Your ticket has been saved and we will review it manually. Please contact support@bongoboss.co.za if urgent.`);
        } finally {
